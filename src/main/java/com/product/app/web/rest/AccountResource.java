...
import com.product.app.domain.User;
import com.product.app.service.InvalidPasswordException;
import com.product.app.service.MailService;
import com.product.app.service.UserService;
import com.product.app.service.UsernameAlreadyUsedException;
import com.product.app.service.dto.PasswordChangeDTO;
import com.product.app.service.dto.UserDTO;
import com.product.app.web.rest.errors.EmailAlreadyUsedException;
import com.product.app.web.rest.errors.EmailNotFoundException;
import com.product.app.web.rest.errors.InvalidPasswordWebException;
import com.product.app.web.rest.errors.LoginAlreadyUsedException;
import com.product.app.web.rest.vm.KeyAndPasswordVM;
import com.product.app.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public CompletionStage<Response> registerAccount(@Valid ManagedUserVM managedUserVM) {
        ...
        } catch (com.product.app.service.EmailAlreadyUsedException e) {
            throw new EmailAlreadyUsedException();
        }
    }
